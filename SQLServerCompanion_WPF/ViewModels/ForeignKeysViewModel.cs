...
{
    [ExportViewModel("ForeignKeysViewModel")]
    [PartCreationPolicy(CreationPolicy.NonShared)]
    public class ForeignKeysViewModel : ViewModelBase
    {
        ...
        private void ExecuteDoSaveAsCommand(Object args)
        {
            ...
            dlg.FileName = "ForeignKeysScript"; // Default file name
        ...
        public void BuildForeignKeyScript(Database selectedDB)
        {
